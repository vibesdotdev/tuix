...
const DocsHandler = async ({ args, flags }: JSXCommandContext) => {
  ...
  return (
    <Box direction="vertical">
      ...
      {openInBrowser && (
        <Text color="dim">(Browser launch not yet implemented)</Text>
      )}
    </Box>
  );
};
          ...
          try {
            ...
            return (
              <Box direction="vertical" gap={1}>
                ...
                {autoRestart && (
                  <Text color="blue">🔄 Auto-restart enabled</Text>
                )}
              </Box>
            );
          } catch (error) {
          ...
          try {
            ...
            return (
              <Box direction="vertical" gap={1}>
                ...
                {stopped && (
                  <Text color="green">✅ Process stopped successfully</Text>
                )}
              </Box>
            );
          } catch (error) {
      ...
      {async ({ args, flags }: JSXCommandContext) => {
        ...
        return (
          <Box direction="vertical" gap={1}>
            ...
            <Text color="yellow">
              ⚠️ Log streaming not yet implemented in TUI mode
            </Text>
            <Text color="dim">
              Use terminal directly:{" "}
              {service ? `pm2 logs ${service}` : "pm2 logs"}
            </Text>
          </Box>
        );
      }}
      ...
      {async ({ args, flags }: JSXCommandContext) => {
        ...
        return (
          <Box direction="vertical" gap={1}>
            ...
            <Text color="dim">
              Would create: package.json, tsconfig.json, src/index.tsx
            </Text>
          </Box>
        );
      }}
        ...
        {async ({ flags }: JSXCommandContext) => {
          ...
          return (
            <Box direction="vertical" gap={1}>
              ...
              <Text color="blue">
                💡 Run 'tuix doctor check' first to see what needs fixing
              </Text>
            </Box>
          );
        }}
