/**
 * Common TUIX Core Types - Basic data structures and validation schemas
 *
 * This module provides fundamental data types used throughout the TUIX framework.
 * These are primarily for validation purposes but also serve as common interfaces
 * that can be shared between different parts of the system.
 */
import { z } from 'zod'
