...
- **NEVER** treat `docs/STATUS.md` as current—it is a stale generated scan. `STATUS.md` at the repo root is the living status.
...
- **ALWAYS** review root `STATUS.md` + `CURRENT.md` before committing
- **NEVER** modify files marked FINAL without explicit confirmation
